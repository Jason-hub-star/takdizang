...
export interface MessageSchema {
  ...
  settingsPage: {
    ...
    usageSection: {
      ...
      monthlyEventsDescription: string;
      exports: string;
      exportsDescription: string;
      estimatedCost: string;
      estimatedCostDescription: string;
      perTypeBreakdown: string;
      perTypeDescription: string;
    ...
    providersSection: {
      ...
      statusMock: string;
      kieAi: string;
      kieAiDescription: string;
      gemini: string;
      geminiDescription: string;
      remotion: string;
      remotionDescription: string;
      apiKeysComingSoon: string;
    };
  };
  modeCard: {
