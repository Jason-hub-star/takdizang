...
## Repo Boundary
- Write repo: `.` (이 CLAUDE.md가 위치한 디렉토리가 루트)
...
4. New folders should include a local `CLAUDE.md` describing structure and conventions.
...
## Source of Truth
- Current runtime/handoff: `docs/status/CLAUDE-HANDOFF.md`
